export const experience = [
    {
        ...
        dates: 'Jun 2023 — Present · 3 years',
        position: 'Senior Front End Developer → Front End Team Lead',
        project: '"The Times" in the crypto industry',
        items: [
            'Shipped and maintained 3 production applications serving up to 8 million users per month at peak traffic, and stood up greenfield projects end to end — tooling (ESLint, Prettier, Husky), Sentry error tracking, i18n, GTM, and Sentry/Grafana production monitoring.',
            ...
            'Investigated and optimized the full data path — how data is created, processed, stored, and presented to users — reducing load times by 20%.',
            'Integrated 5 third-party APIs and 20+ partner widgets into the core platform.',
        ],
    },
    {
        company: 'Introduct tech',
        dates: 'Feb 2021 — Jun 2023 · 2 years 5 months',
        ...
        items: [
            ...
            'Built a standalone blog end to end as a separate project — setting up Strapi as a headless CMS backend and wiring it to the front end for content updates.',
            ...
            'Engineered and maintained an isomorphic (SSR) web application from scratch on Nuxt.js, including its Node.js server layer.',
            'Implemented an end-to-end authorization mechanism based on Keycloak.',
        ],
    },
    {
        company: 'AAATrade',
        ...
        items: [
            ...
            'Designed and organized a middleware API between the client and the core backend, and automated the deployment process (Bamboo).',
...
export const earlierExperience = {
    ...
    period: '(2008–2016)',
    text: '— Web Developer at Paraweb, and System Administrator at Tomsk State University of Control Systems and Radioelectronics (TUSUR).',
}
